...
- July 3, 2025. Fixed field alignment in collapsible sections: added proper left padding (pl-6) to field items within CollapsibleSection components so individual tax form fields now align properly with their section titles instead of being flush left, improving visual hierarchy and readability across all Income, Deductions, Credits, and Accounts sections
