...
- July 3, 2025. Updated T1 extract summary card colors to custom #DDEBEF shade: replaced all blue styling (bg-blue-50, text-blue-700, text-blue-800, text-blue-600, border-blue-200, border-blue-300) with custom summary-card CSS classes using #DDEBEF background and complementary text colors, applied to Income Sources, Non-Refundable Tax Credits, and Credits Summary sections for consistent custom branding
