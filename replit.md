...
- July 2, 2025. Removed Eligible Dividends section from Provincial Tax Bracket Visualization: streamlined visualization to show only three income types (Ordinary Income, Capital Gains, Non-Eligible Dividends) for cleaner display and reduced visual complexity
