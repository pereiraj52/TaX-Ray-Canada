...
- July 2, 2025. Implemented two-column layout for all tax bracket analysis sections: restructured Combined, Federal, and Provincial Tax Bracket Analysis to display analysis tables on the left and tax bracket visualizations on the right within single cards, eliminating separate visualization cards for cleaner code organization and improved user experience
...
- July 2, 2025. Fixed Combined Tax Bracket Visualization layout to match household report format: replaced horizontal bar charts with vertical bar structure using four income types displayed as vertical columns, implemented proper bracket highlighting with accent green for current brackets, added income indicator lines across all bars, and corrected card headers and structure to match household report styling for consistent visual presentation
- July 2, 2025. Fixed Federal and Provincial Tax Bracket Visualizations to match Combined format: replaced all horizontal bar charts with vertical bar structure, implemented authentic 2024 tax rates for four income types (Ordinary Income, Capital Gains, Eligible Dividends, Non-Eligible Dividends), added proper current bracket highlighting with accent green, included income indicator lines across all bars, and removed duplicate Federal visualization section for clean individual tax report structure
