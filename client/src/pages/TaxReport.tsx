                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <div className="text-right font-mono">
                            <span className="font-medium">
                              ${totalIncomeSum.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} <span className="text-sm text-gray-500 font-sans">(100.0%)</span>
                            </span>
                          </div>
                        </div>
                        <div className="flex justify-between items-center">
                          ...
                          <div className="text-right font-mono">
                            <span className="font-medium">
                              ${totalDeductionsSum.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} <span className="text-sm text-gray-500 font-sans">({calculatePercentage(totalDeductionsSum)})</span>
                            </span>
                          </div>
                        </div>
                      </>
