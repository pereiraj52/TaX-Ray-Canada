  ...
  private static convertToT1ExtractedData(comprehensiveData: any): T1ExtractedData {
    ...
    if (comprehensiveData.refund) {
      const refundMapping = {
        ...
        working_income_tax_benefit: { code: '45300', name: 'Canada Workers Benefit' },
        ...
        journalism_labour_tax_credit: { code: '47555', name: 'Canadian Journalism Labour Tax Credit' },
        fuel_charge_farmers_tax_credit: { code: '47556', name: 'Return of Fuel Charge Proceeds to Farmers' },
